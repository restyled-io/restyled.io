    ...
    <$> upsert
      MarketplacePlan
        ...
        , marketplacePlanPrivateRepoAllowance =
            inferPrivateRepoAllowanceByName
        ...
        , marketplacePlanMemory =
            inferMemoryRestrictionByName
              $ GH.marketplacePlanName plan
        }
      [ MarketplacePlanName =. GH.marketplacePlanName plan
      , MarketplacePlanDescription =. GH.marketplacePlanDescription plan
...
synchronizeAccount planId account =
  entityKey
    <$> upsert
      MarketplaceAccount
      ...
      , MarketplaceAccountBillingEmail
          =. GH.marketplaceAccountOrganizationBillingEmail account
      , MarketplaceAccountMarketplacePlan =. planId
      , MarketplaceAccountTrialEndsAt
          =. GH.marketplacePurchaseFreeTrialEndsOn
